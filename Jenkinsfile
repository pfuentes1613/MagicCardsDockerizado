 ...
 stage("Crear cluster en ECS"){
      steps {
          script {
            ...
            aws ecs create-service --cluster fargate-cluster --service-name fargate-service --task-definition ecs-pab:1 --desired-count 1 --launch-type "FARGATE" --network-configuration "awsvpcConfiguration={subnets=[subnet-01080beb2830822ff],securityGroups=[sg-03edc70db8ed5a7b0],assignPublicIp=ENABLED}"
